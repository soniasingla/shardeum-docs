...
And follow these [instructions](https://docs.shardeum.org/faucet/claim) to add Shardeum to MetaMask wallet and claim test 100 $SHM tokens from Sphinx faucet.
